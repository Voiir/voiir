...
import { HOME_PAGE_ROUTE, ONBOARDING_PAGE_ROUTE } from '../../routes/route-paths';
      ...
      <div className={loginStyles.backdrop}>
        <div className={loginStyles.login}>
          ...
          <div className={loginStyles.popup}>
            ...
            <GoogleLogin
              render={(renderProps) => (
                <div onClick={renderProps.onClick} disabled={renderProps.disabled} className={loginStyles.loginButton}>
                  login with google
                </div>
              )}
